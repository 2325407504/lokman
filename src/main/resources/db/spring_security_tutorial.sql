...
-- john's password: admin (authorities = "ROLE_ADMIN, ROLE_USER, ROLE_VISITOR")
-- jane's password: user (authorities = "ROLE_USER, ROLE_VISITOR")
-- mike's password: visitor (authorities="ROLE_VISITOR")
--
...
(3, 'Mike', 'Mikey', '127870930d65c57ee65fcc47f2170d38', 'mike');

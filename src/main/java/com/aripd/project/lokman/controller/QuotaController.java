...
import com.aripd.project.lokman.validator.QuotaValidator;
...
public class QuotaController {
	...
	public String listAction(Model model) {
		...
		model.addAttribute("quotaAttribute", quotaService.getAll());
		return "quota/list";
	}
    ...
    public String editAction(@PathVariable Long id, Model model) {
    	...
    	model.addAttribute("quotaAttribute", quotaService.getOne(id));
    	return "quota/form";
	}

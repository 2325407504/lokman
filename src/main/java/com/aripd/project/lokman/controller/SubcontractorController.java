...
import com.aripd.project.lokman.validator.SubcontractorValidator;
...
public class SubcontractorController {
	...
	public String listAction(Model model) {
		...
		model.addAttribute("subcontractorAttribute", subcontractorService.getAll());
    ...
    public String editAction(@PathVariable Long id, Model model) {
    	...
    	model.addAttribute("subcontractorAttribute", subcontractorService.getOne(id));
    	return "subcontractor/form";
	}

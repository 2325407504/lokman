...
import com.aripd.project.lokman.domain.Forwarding_;
import com.aripd.project.lokman.report.forwarding.FillManager;
import com.aripd.project.lokman.report.forwarding.Layouter;
import com.aripd.project.lokman.report.forwarding.Writer;
import com.aripd.project.lokman.repository.ForwardingRepository;
...
public class ForwardingServiceImpl implements ForwardingService {
	...
	protected static Logger logger = Logger.getLogger(ForwardingServiceImpl.class);
	...
	public Forwarding getOne(Long id) {
		logger.debug("Retrieving record based on his id");
	...
	@Transactional(readOnly = false)
	public Forwarding delete(Long id) {
		Forwarding forwarding = repository.findOne(id);
	...
	@Transactional(readOnly = true)
	@Override
	public ResultSet<Forwarding> getDataTables(PagingCriteria criteria) {

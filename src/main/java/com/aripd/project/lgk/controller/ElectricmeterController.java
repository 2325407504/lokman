...
public class ElectricmeterController {
    ...
    public @ResponseBody
    WebResultSet<Electricmeter> getDataTables(@TableParam PagingCriteria criteria) {
        ResultSet<Electricmeter> resultset = this.electricmeterService.getRecords(criteria);

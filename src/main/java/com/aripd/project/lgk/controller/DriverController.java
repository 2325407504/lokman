...
public class DriverController {
	...
	public @ResponseBody
	WebResultSet<Driver> getDataTables(@TableParam PagingCriteria criteria) {
		ResultSet<Driver> resultset = this.driverService.getRecords(criteria);
    ...
    public String saveAction(
    		...
    		@ModelAttribute("driverAttribute") @Valid Driver driver, 

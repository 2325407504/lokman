...
<div class="container">
	<div class="span12">
		<ul class="breadcrumb">
		  ...
		  <li><a href="#"><spring:message code="Trip Tracking"></spring:message></a> <span class="divider">/</span></li>
		  <li class="active"><spring:message code="New entry"></spring:message></li>
		</ul>
		<c:url var="saveUrl" value="/trip/save" />
		<form:form modelAttribute="tripAttribute" action="${saveUrl}" method="post">
			<form:errors path="*" cssClass="error-block" element="div" />
			<form:hidden path="id" />
			<fieldset>
				<div class="form-row">
					<form:label path="publishedAt"><spring:message code="Date" text="Date"></spring:message></form:label>
				...
				<div class="form-row">
					...
					<span><form:input path="startingTime" /></span>
				...
				<div class="form-row">
					...
					<span><form:input path="endingTime" /></span>
		...
		<c:if test="${ !empty tripAttribute.id }">
		<c:url var="deleteUrl" value="/trip/delete?id=${tripAttribute.id}" />

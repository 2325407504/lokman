...
<div class="container">
	<div class="span12">
		<ul class="breadcrumb">
		  ...
		  <li><a href="#"><spring:message code="Shifts" text="Shifts"></spring:message></a> <span class="divider">/</span></li>
		  <li class="active"><spring:message code="New entry"></spring:message></li>
		</ul>
		<c:url var="saveUrl" value="/shift/save" />
		...
		<c:if test="${ !empty shiftAttribute.id }">
		<c:url var="deleteUrl" value="/shift/delete?id=${shiftAttribute.id}" />

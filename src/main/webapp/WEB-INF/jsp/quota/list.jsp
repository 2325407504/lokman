...
<ul class="breadcrumb">
  ...
  <li class="active"><spring:message code="Quotas"></spring:message></li>
</ul>

<spring:url var="addUrl" value="/quota/new" />
<div class="form-actions">
	<a class="btn" href="${addUrl}"><spring:message code="New Entry"></spring:message></a>
</div>

<table class="table">
	<caption><spring:message code="Quotas"></spring:message></caption>
	<thead>
		<tr>
	...
	<tbody>
		<c:forEach items="${quotaAttribute}" var="quota">
			<spring:url var="editUrl" value="/quota/edit/${quota.id}" />
			<tr>
				<td><c:out value="${quota.id}" /></td>
				<td><c:out value="${quota.name}" /></td>
				<td>
...
<c:if test="${empty quotaAttribute}">

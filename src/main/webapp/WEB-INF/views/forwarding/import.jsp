...
<div class="bs-docs-example" data-content="<spring:message code="Waybill" />">
    <spring:url var="forwardingImport" value="/forwarding/import" />
    <form:form modelAttribute="forwardingImportAttribute" action="${forwardingImport}" method="post" enctype="multipart/form-data">

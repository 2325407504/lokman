...
<spring:url var="productionImportCSV" value="/production/import/csv" />
...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="${productionImportXLSX}"><spring:message code="Import"></spring:message></a></li>
	<li class="dropdown">
...
<div class="bs-docs-example hide" data-content="<spring:message code="CSV"></spring:message> - <spring:message code="Waybill"></spring:message>">
	<form:form modelAttribute="csvImportBean" action="${productionImportCSV}" method="post" enctype="multipart/form-data">
		<div class="row-fluid">

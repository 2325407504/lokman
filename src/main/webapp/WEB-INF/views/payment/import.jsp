...
<div class="bs-docs-example" data-content="<spring:message code="Payment" />">
    <spring:url var="paymentImport" value="/payment/import" />
    <form:form modelAttribute="paymentImportAttribute" action="${paymentImport}" method="post" enctype="multipart/form-data">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><spring:message code="Paymenttype" /></th>

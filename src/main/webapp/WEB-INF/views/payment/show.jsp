...
<div class="row-fluid">
    <div class="span12">
        <aripd:description id="payment">
            <aripd:descriptionitem label="Account" field="paymentAttribute.account.employee.fullname"></aripd:descriptionitem>
            ...
            <aripd:descriptionitem label="Company" field="paymentAttribute.company"></aripd:descriptionitem>
            <aripd:descriptionitem label="Description" field="paymentAttribute.description"></aripd:descriptionitem>

<!--
Ref: http://www.developer.com/java/web/article.php/10935_3830886_3/A-Pagination-Technique-Using-Spring.htm
Usage: <aripd:paging pagedListHolder="${pagedListHolder}" pagedLink="${pagedLink}"/>
-->
<%@ tag description="The pagedListHolder and current page are passed to it as parameters. The tag then correctly displays page links, including arrows and gaps in pages if the number exceeds specific display limits." pageEncoding="UTF-8"%>
